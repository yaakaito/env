...
- Do not dig into what is cheap to adjust later: coding style preferences, naming details, wording, fine-grained UI. Decide these yourself and move on — they are easier to tune once something exists to look at
